...
endforeach;
$login_id=$this->db->get_where('users' , array('id'=>$employee_id))->row()->login_id;
...
$ol="employee_id=".$employee_id." AND time_off_status='1'";
$this->db->select('*');
$this->db->from('time_off');
$this->db->where($ol);
									...
									<div class="row">
                                            ...
                                            <hr>
															...
															?>
															 ...
															 <a href="#">
                                                                    <p>
                                                                        Days left
                                                                        <span class="pull-right">
                                                                            <strong><?php echo $remaining_days;?> Days</strong>
                                                                        </span>
                                                                    </p>
                                                                    <div class="progress">
                                             ...
                                             <hr>
                                             	...
                                             	<center>
                                                    <div class="btn-group">
                                                        <a class="btn btn-blue" href="#" onclick="confirm_activate('<?php echo base_url();?>manager/requests/approve/<?php echo $time_off_id;?>');"><i class="fa fa-check"></i> Approve</a>
                                                    </div>
                                                   <div class="btn-group">
                                                        <a class="btn btn-red" href="#" onclick="confirm_deactivate('<?php echo base_url();?>manager/requests/decline/<?php echo $time_off_id;?>');"><i class="fa fa-times"></i> Decline</a>
                                                    </div>
                                                 </center>
                                                    <?php }endif; if($request_status=="2"):?>
                                                    <?php if($r_difference=="+"){?>
                                                   <div class="btn-group">
                                                        <a class="btn btn-red" href="#" onclick="confirm_deactivate('<?php echo base_url();?>manager/requests/decline/<?php echo $time_off_id;?>');"><i class="fa fa-times"></i> Decline</a>
                                                    </div>
                                                    <?php }endif;?>
                                                    <?php if($request_status=="3"):?>
                                                    <?php if($r_difference=="+"){?>
                                                    <div class="btn-group">
                                                        <a class="btn btn-blue" href="#" onclick="confirm_activate('<?php echo base_url();?>manager/requests/approve/<?php echo $time_off_id;?>');"><i class="fa fa-check"></i> Approve</a>
                                                    </div>
