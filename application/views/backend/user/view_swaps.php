									...
									<div class="row">
                                            ...
                                            <br>
                                                ...
                                                <div class="list-group">
                                                    ...
                                                    <a href="<?php echo base_url()?>user/schedule_swap" class="list-group-item">Swaps<span class="badge purple"><?php echo $count_all_swaps;?></span></a>
                                            ...
                                            <hr>
                                             ...
                                             <hr>
                                                ...
                                                <?php if($s_status=="0"):?>
                                                    <div class="btn-group">
                                                        <a class="btn btn-blue" onclick="showAjaxModalSmall('<?php echo base_url();?>user/requests/swap_edit/<?php echo $swap_id;?>');"><i class="fa fa-edit"></i> Edit</a>
                                                    </div>
                                                    <?php endif?>
                                                    <div class="btn-group">
                                                        <a class="btn btn-default" href="<?php echo base_url()?>user/schedule_swap"><i class="fa fa-arrow-circle-right"></i> All Swaps</a>
                                                    </div>
                                                 </center>
                                            </div>
                                        </div>
